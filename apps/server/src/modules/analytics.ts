import { CORE_EVENTS, isInteractive, resolveVariant, type FunnelConfig, type ResolvedFunnel, type StepType } from '@funnel/shared';
import type { Db } from '../db.js';
import { notFound } from '../errors.js';
import { mde, newcombeDiff, ratio, srmChiSquare, twoProportionZTest, wilson, type Interval } from './stats.js';
