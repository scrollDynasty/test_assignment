...
> Исторический документ: план до первого коммита. Отличия реализации (маршруты `/internal/*`, отвал по самому
> дальнему шагу, хостинг Railway вместо Fly.io и др.) — в [WORKLOG](../WORKLOG.md).
